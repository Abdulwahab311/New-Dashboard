...
const MOCK_DATA = [
  ...
  {
    street: "Project C",
    progress: { value: 21, total: 30, barColor: "#ED5E23" },
    stageData: {
      signed: { done: true, color: "#ED5E23" },
      complete: { done: true, color: "#ED5E23" },
      notary: { done: true, color: "#ED5E23" },
      transfer: {},
    },
  },
  {
    street: "Project D",
    progress: { value: 25, total: 30, barColor: "#2FC639" },
    stageData: {
      signed: { done: true, color: "#3B82F6" },
      complete: { done: true, color: "#3B82F6" },
      notary: { done: true, color: "#3B82F6" },
      transfer: { done: true, color: "#3B82F6" },
    },
  },
];
