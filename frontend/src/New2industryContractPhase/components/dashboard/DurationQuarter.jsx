...
const MOCK_DEAL_PHASES = [
  {
    title: "Dossier registratie in CRM & financieel",
    goalDays: 1,
    nowDays: 1,
    gaugeColor: "#22C55E",
  },
  { title: "Lopende Zaken", goalDays: 1, nowDays: 7, gaugeColor: "#F97316" },
  {
    title: "Projectregistratie administratief en financieel",
    goalDays: 1,
    nowDays: 7,
    gaugeColor: "#EF4444",
  },
  {
    title: "Plan Fiscaal en Notaris akkoord",
    goalDays: 3,
    nowDays: 7,
    gaugeColor: "#22C55E",
  },
  { title: "TDD", goalDays: 14, nowDays: 14, gaugeColor: "#22C55E" },
];
...
const DurationQuarter = () => {
  ...
  return (
    <div className="text-white w-full h-full">
      <h1 className="text-lg md:text-xl font-bold mb-4">AVG DURATION TIME</h1>
      ...
      <div className="flex flex-col xl:flex-row gap-4 xl:gap-6">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <div className="px-5 md:px-6 py-2 md:py-2.5 rounded-full bg-[#22C55E] text-center">
        ...
        <div className="flex gap-2 overflow-x-auto pb-2">
          ...
          <div className="flex flex-col bg-[#1A1F3A] p-0.5 items-center flex-shrink-0">
            <div className="bg-[#1A1F3A] rounded-lg p-2 mb-2 w-[75px]">
          ...
          {dealPhases.map((phase, index) => {
            ...
            return (
              ...
              >
                {/* Phase Info Box */}
                <div className="bg-[#1A1F3A] rounded-lg p-2 mb-2 w-[65px]">
